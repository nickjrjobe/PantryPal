...
class VoiceToTextStub implements VoiceToText{
    ...
    public String getTranscript(){String response = waitingForMeal ? mealType : ingredients;
...
public class NewRecipeTest {
	...
	public void testInterpretRecipeResponse() {
        ...
        assertEquals(newRecipeCreatorTest.interpretRecipeResponse("Tea\nPut teabag into hot water\n").getDescription(), new Recipe("Tea","Put teabag into hot water").getDescription());
        /*single line comment*/
         assertEquals(newRecipeCreatorTest.interpretRecipeResponse("Tea:Put teabag into hot water"), null);
	}
    ...
    public void testNewRecipe(){
        ...
        assertEquals(new Recipe("Instant Noodles", "Add noodles to boiling water for two minutes").getDescription(), newRecipeCreatorTest.interpretRecipeResponse(recipeCreatorTest.recipe).getDescription());
    }
